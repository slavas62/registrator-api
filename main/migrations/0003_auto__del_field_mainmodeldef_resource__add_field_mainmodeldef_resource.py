...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MainModelDef.resource_type'
        db.add_column('main_modeldefinition', 'resource_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MainModelDef.resource_type'
        db.delete_column('main_modeldefinition', 'resource_type')
